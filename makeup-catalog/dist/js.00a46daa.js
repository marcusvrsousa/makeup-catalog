...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"js/index.js":[function(require,module,exports) {
var axios = require('axios');

// Make a request for a user with a given ID
axios.get('http://makeup-api.herokuapp.com/api/v1/products.json').then(function (response) {
  // handle success
